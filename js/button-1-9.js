...
function load_prismjs_stuffs(ed) {
  ...
  tinymce.create('tinymce.plugins.vecb_button9', {
    init : function(ed, url) {
      ed.addButton('vecb_button9', {
        title : 'Apply PrismJS',image : url+'/icons/magic.png', onclick : () => load_prismjs_stuffs(ed)
      });
      setTimeout(() => load_prismjs_stuffs(ed), 1000)
    },
